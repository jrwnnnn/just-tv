...
<body class="min-h-screen bg-neutral-900 text-white p-8">
    ...
    <div class="grid md:grid-cols-5 gap-5">
        <?php foreach ($channels as $channel): ?>
            <div class="flex flex-col items-center justify-center bg-neutral-800 rounded-lg p-10 hover:bg-neutral-700 transition" onclick="window.location.href='<?= $channel['id']; ?>'">
