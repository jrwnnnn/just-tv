...
<body class="min-h-screen bg-neutral-900 text-white">
    ...
    <div class="flex justify-between items-center mt-4 mx-[10rem]">
        <img class="w-20 invert scale-x-[-1] hover:cursor-pointer" src="https://cdn-icons-png.flaticon.com/128/15948/15948774.png" onclick="history.replaceState(null, '', 'player2.php?channel=<?= $previousChannel ?>'); location.reload();">
        ...
        <img class="w-20 invert hover:cursor-pointer" src="https://cdn-icons-png.flaticon.com/128/15948/15948774.png" onclick="history.replaceState(null, '', 'player2.php?channel=<?= $nextChannel ?>'); location.reload();">
    </div>    
